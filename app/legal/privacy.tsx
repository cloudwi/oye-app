...
• 직접 입력 정보: 이름, 성별, 생년월일, 태어난 시각, 양력/음력 구분, 직업, MBTI, 혈액형, 관심사/취미
...
• 회원 식별 및 서비스 로그인
• 생년월일, 태어난 시각, 성별, 직업, MBTI, 혈액형, 관심사 기반의 맞춤형 운세 콘텐츠 생성
...
• AI 운세 생성: Google Gemini (생년월일, 태어난 시각, 성별, 직업, MBTI, 혈액형, 관심사 기반 콘텐츠 생성, 개인 식별 불가 형태로 전달)`,
  },
  {
